...
const double Simulator::NitroDeltaY = 0.002497639;
...
void Simulator::simulate_one_tick_nitro_jump(RobotEntity & re)
{
	...
	auto averageTickNitro = re.Nitro - averageTickDeltaNitro;
	if (averageTickNitro < 0)
		averageTickNitro = 0.0;

	auto targetVelocityChange = Helper::Clamp(targetVelocity - re.Velocity, averageTickNitro * Constants::Rules.NITRO_POINT_VELOCITY_CHANGE);
